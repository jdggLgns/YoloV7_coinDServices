...
class object_detection:
        ...
        def calculate(self, nameIMG):
                ...
                ##img = cv2.imread(os.path.join(self.UPLOAD_FOLDER, self.alphanumeric_filename))
                ...
                #self.generate_image_with_probabilities(boxes, indexes, class_ids, confidences, img)
